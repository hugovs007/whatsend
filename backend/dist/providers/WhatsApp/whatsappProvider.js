...
exports.whatsappProvider = {
    sendMessage: (ticket, body, quotedMsg) => __awaiter(void 0, void 0, void 0, function* () {
        console.log("Meta API Dummy: sendMessage");
    }),
    sendSeen: (whatsappId, number) => __awaiter(void 0, void 0, void 0, function* () {
        console.log("Meta API Dummy: sendSeen");
    }),
    removeSession: (whatsappId) => {
        console.log("Meta API Dummy: removeSession", whatsappId);
    },
    logout: (whatsappId) => __awaiter(void 0, void 0, void 0, function* () {
